...
export function LoginPanel() {
  ...
  return <div className="relative w-full max-w-md border border-brass-600/50 bg-noir-800/90 p-8 shadow-2xl">
    ...
    <form className="space-y-5" onSubmit={submit}>
      <AuthTextField id="email" name="email" type="email" label="이메일" autoComplete="email" required placeholder="user@example.com" />
    ...
    <p className="mt-6 text-center text-sm text-parchment-300/70">아직 등록되지 않았나요? <Link href="/signup" className="text-brass-400 hover:underline">수사관 등록하기</Link></p>
