...
export type Difficulty = { difficulty: 'easy' | 'normal' | 'hard'; questionsPerSuspect: number; totalQuestions: number; timeLimitSeconds: number | null; dialectLevel: string; hintLimit: number };
...
export type PublicSuspect = { id: string; code: string; name: string; age: number | null; occupation: string | null; publicProfile: { summary?: string }; personality: string | null; victimRelation: string | null; initialEmotion: string; displayOrder: number; imageUrl: string | null };
