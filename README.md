...
> 사투리가 단순한 지역색이 아니라 말의 표면과 진의를 해석하는 추리 단서가 될 수 있다는 점이 가장 인상 깊었습니다. 짧은 기간의 콘텐츠 제작을 통해 작은 표현 하나를 세심하게 다듬는 일이 게임의 몰입도와 완성도를 만든다는 것을 배웠습니다.

**손기환:**

> AI 이미지 생성에서는 문구, 지명, 인물과 소품의 특징까지 구체적으로 전달해야 스토리에 맞는 결과를 얻을 수 있다는 점을 배웠습니다. AI 활용의 완성도는 필요한 맥락을 얼마나 명확하게 언어화하고 작은 어긋남을 끝까지 다듬는지에 달려 있다는 것이 크게 남았습니다.
