...
const specs: EpisodeSpec[] = [
  {
    ...
    suspects: [
      { name: '이순임', age: 58, occupation: '종부·김재현의 아내', culprit: true, profile: '오랫동안 종가 살림과 제사 준비를 맡아 온 종부다.', fact: '유언장에서 자신의 몫이 삭제된 것을 알고 초오를 탄 안동식혜를 건넸다.', lie: '식혜를 가져다준 뒤에는 다시 사랑채에 가지 않았다고 주장한다.', response: '유언장을 언급하면 방어적으로 변하고 초오와 뒷산을 추궁하면 동요한다.' },
      { name: '김도현', age: 42, occupation: '둘째아들', profile: '고향을 떠나 지내다 최근 집안일로 돌아온 둘째아들이다.', fact: '18시경 아버지를 밀쳐 문틀에 머리를 부딪히게 했지만 그 상처는 사인이 아니었다.', lie: '아버지와 크게 싸우지 않았다고 주장한다.', response: '몸싸움을 추궁하면 자신이 죽였을지도 모른다는 두려움 속에서 사실을 털어놓는다.' },
      { name: '박말순', age: 71, occupation: '행랑어멈', profile: '오랫동안 종가의 집안일을 도우며 지내 온 가족 구성원이다.', fact: '21시경 사랑채에서 신음 소리를 들었으나 그냥 지나쳤다.', lie: '그날 밤 아무 소리도 듣지 못했다고 주장한다.', response: '신분과 신음 소리를 함께 추궁하면 침묵한 이유를 밝히며 오열한다.' },
      { name: '김판석', age: 71, occupation: '문중회장·6촌 형', profile: '문중의 주요 의사결정과 재산 관리를 맡고 있는 친족이다.', fact: '김재현이 땅을 팔아 둘째아들의 사업자금을 대주려던 계획을 알고 있다.', lie: '땅 문제는 이미 모두 해결됐다고 주장한다.', response: '위토답 문제를 추궁하면 거만한 태도에서 방어적으로 변한다.' }
    ],
    ...
    clues: [['유언장 초안', '배우자 몫이 빠진 초안은 가족 내부 갈등이 깊었음을 보여준다.'], ['부검 소견서', '김도현과의 몸싸움에서 생긴 두부 외상은 사인이 아니었다.'], ['문틀 흔적과 김도현의 진술', '문틀의 충돌 흔적은 부검상 치명상과 일치하지 않는다.'], ['박말순의 신음 소리 증언', '피해자가 21시경 살아 있었음을 보여준다.'], ['옥비녀', '이순임이 사랑채에 다시 들어갔음을 뒷받침한다.']],
  ...
  },
  {
    ...
    suspects: [
      { name: '정춘삼', age: 60, occupation: '동업자·부사장', culprit: true, profile: '오랫동안 피해자와 회사를 함께 운영해 온 공동 경영자다.', fact: '장부 검토로 횡령이 발각될 것을 막으려 저울추로 서병만을 살해했다.', lie: '사건 당시 계속 사무실에 있었다고 주장한다.', response: '회계사와 장부를 언급하면 동요하고 CCTV를 제시하면 격앙된다.' },
      { name: '최말자', age: 55, occupation: '가공팀 반장', profile: '가공 현장에서 오랫동안 직원들을 이끌어 온 작업 반장이다.', fact: '서병만의 위암 말기 진단서와 장부를 모두 밝히겠다는 말을 알고 있다.', lie: '진단서를 본 사실만 끝까지 숨긴다.', response: '임금 문제에는 당당하지만 진단서를 언급하면 크게 동요한다.' },
      { name: '서지영', age: 35, occupation: '피해자의 딸', profile: '서울에서 생활하다 사건 소식을 듣고 내려온 피해자의 딸이다.', fact: '전날 밤 아버지에게 유언장을 다시 쓰겠다는 전화를 받았다.', lie: '최근 아버지와 거의 연락하지 않았다고 주장한다.', response: '마지막 전화 내용을 추궁하면 화해의 기회를 놓친 일을 후회한다.' },
      { name: '오갑수', age: 58, occupation: '목포 경쟁업체 사장', profile: '인근에서 같은 업종의 회사를 운영하는 사업가다.', fact: '정춘삼과 회사 인수 문제로 은밀히 통화했다.', lie: '서병만과 최근 연락하지 않았다고 주장한다.', response: '인수 협상을 언급하면 여유를 잃고 당황한다.' }
    ],
    ...
    clues: [['조작된 장부 숫자', '장부 숫자가 여러 차례 덧씌워져 내부 자금 흐름을 다시 확인해야 한다.'], ['회계사 통화', '사건 직전 외부 회계사가 전체 장부를 검토하기로 했음을 보여준다.'], ['CCTV와 진술의 모순', '사건 시각 사무실에 있었다는 진술과 창고 주변 동선이 충돌한다.'], ['최말자가 본 진단서', '최말자의 침묵은 살인 은폐가 아니라 피해자의 병을 지키려던 행동이었다.'], ['서지영의 마지막 통화', '유언장 이야기는 상속 다툼이 아니라 딸과의 화해 시도였다.']],
  ...
  },
  {
    ...
    suspects: [
      { name: '노방석', age: 21, occupation: '무직', profile: '마을에서 지내며 피해자의 가게 주변을 자주 오가던 청년이다.', fact: '19시 30분경 부엌 뒤편에서 몰래 담배를 피운 뒤 귀가했다.', lie: '그날은 집에서 계속 자고 있었다고 주장한다.', response: '초저녁에 현장에 있었지만 범행 시각에는 이미 귀가했다고 말한다.' },
      { name: '맹용식', age: 24, occupation: '일용직 노동자', culprit: true, profile: '마을에서 일용직으로 일하며 피해자와 알고 지내던 청년이다.', fact: '돈궤를 훔치다 발각되자 피해자를 살해하고 주방에 불을 질렀다.', lie: '그날 밤 내내 당구장에 있었다고 주장한다.', response: '그을음과 장부 조작을 추궁하면 공격적으로 증거를 요구한다.' },
      { name: '목성구', age: 20, occupation: '배달원', profile: '마을의 배달 일을 하며 가게를 자주 방문하던 청년이다.', fact: '23시 35분경 그을음이 묻은 맹용식이 당구장에 도착해 장부를 고치는 것을 봤다.', lie: '맹용식이 처음부터 당구장에 있었다고 주장한다.', response: '협박을 두려워하지만 도착 시각과 그을음을 차츰 털어놓는다.' },
      { name: '표성두', age: 19, occupation: '고등학교 중퇴', profile: '마을에서 지내며 다른 용의자들과 어울리던 청년이다.', fact: '23시 43분 맹용식에게 거짓 알리바이를 강요하는 협박 전화를 받았다.', lie: '맹용식과 당구장에 함께 있었다고 주장한다.', response: '통화 기록을 제시하면 보복이 두려워 거짓말했다고 밝힌다.' }
    ],
    ...
    clues: [['손목시계', '사건의 핵심 시각이 밤 11시 10분임을 보여준다.'], ['노방석의 시간 표현', '노방석은 초저녁에 현장을 떠나 핵심 시각과 동선이 겹치지 않는다.'], ['목성구의 그을음 증언', '화재 뒤 당구장에 늦게 들어온 사람의 옷에 그을음이 묻어 있었다.'], ['조작된 당구장 장부', '원래 입장 시각은 23시 38분으로, 22시부터 함께 있었다는 진술과 맞지 않는다.'], ['표성두의 통화기록', '화재 뒤 여러 사람의 알리바이를 맞추려 한 통화 정황이 남아 있다.'], ['녹색 테이프 라이터', '현장 라이터의 테이프 표식이 한 용의자의 소지품 표시 습관과 일치한다.']],
  ...
  },
  {
    ...
    suspects: [
      { name: '문태오', age: 22, occupation: '별장 관리 보조', profile: '별장의 일상 관리와 잔심부름을 맡아 온 보조 직원이다.', fact: '18시 40분경 탕비실에서 고급 찻잎을 조금 훔쳤다.', lie: '탕비실 근처에도 가지 않았다고 주장한다.', response: '해가 지기 전 찻잎을 가져갔을 뿐 밤에는 들어가지 않았다고 밝힌다.' },
      { name: '강윤호', age: 29, occupation: '개인 운전기사', culprit: true, profile: '피해자의 차량 운행과 외부 일정을 담당해 온 운전기사다.', fact: '차량 비용 횡령이 발각되자 차에 독을 넣고 비밀 장부를 훔쳤다.', lie: '사건 당시 직원들과 탑동에서 계속 술을 마셨다고 주장한다.', response: '흰 가루와 출입 기록을 제시하면 공격적으로 증거를 요구한다.' },
      { name: '양재우', age: 27, occupation: '별장 경비원', profile: '별장 출입 확인과 야간 경비를 맡아 온 직원이다.', fact: '22시 50분경 서재에서 나오는 강윤호와 소매의 흰 가루를 봤다.', lie: '직원 모두 탑동에 함께 있었다고 주장한다.', response: '협박을 두려워하지만 강윤호의 소매에 흰 가루가 많이 묻었다고 증언한다.' },
      { name: '오민석', age: 23, occupation: '정원 관리 보조', profile: '별장 정원과 외부 시설 관리를 보조해 온 직원이다.', fact: '23시 27분 강윤호에게 공동 알리바이를 강요하는 협박 전화를 받았다.', lie: '직원 모두 탑동에 있었다고 주장한다.', response: '통화 기록을 제시하면 누명을 쓸까 두려워 거짓말했다고 밝힌다.' }
    ],
    ...
    clues: [['문태오의 방문 시각', '문태오의 탕비실 방문은 해가 지기 전이어서 독 투입 시간과 다르다.'], ['양재우의 흰 고루 증언', '22시 50분 서재에서 나온 사람의 소매에 흰 가루가 많이 묻어 있었다.'], ['정문 출입기록', '23시 18분 차량 출입은 탑동에 계속 있었다는 공동 진술과 충돌한다.'], ['오민석의 통화기록', '23시 27분 동료에게 공동 알리바이를 요구한 정황이 남아 있다.'], ['장부 복사본', '비밀 장부에는 특정 차량 비용이 반복해서 부풀려진 기록이 남아 있다.'], ['찻잔과 빈 약품 포장지', '찻잔의 성분과 빈 포장지는 탕비실에서 독성 물질이 사용됐음을 보여준다.']],
