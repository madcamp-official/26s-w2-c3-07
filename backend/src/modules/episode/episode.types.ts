...
export type Difficulty = { difficulty: string; questionsPerSuspect: number; totalQuestions: number; timeLimitSeconds: number | null; dialectLevel: number; hintLimit: number };
