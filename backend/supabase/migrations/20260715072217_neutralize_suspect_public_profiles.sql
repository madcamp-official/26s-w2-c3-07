...
set public_profile = jsonb_build_object('summary', case code
...
where code in ('GS-01-S1','GS-01-S2','GS-01-S3','GS-01-S4','JL-01-S1','JL-01-S2','JL-01-S3','JL-01-S4','CC-01-S1','CC-01-S2','CC-01-S3','CC-01-S4','JJ-01-S1','JJ-01-S2','JJ-01-S3','JJ-01-S4');

update game_content.suspects set victim_relation = case code
